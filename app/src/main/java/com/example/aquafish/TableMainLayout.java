...
public class TableMainLayout extends RelativeLayout {
    ...
    TextView bodyTextView(String label){
        ...
        if(label.indexOf("Col 1")>-1)
            bodyTextView.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary));
        else
    ...
    TextView headerTextView(String label){
        ...
        headerTextView.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary));
