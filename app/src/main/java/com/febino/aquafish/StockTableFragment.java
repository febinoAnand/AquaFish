...
public class StockTableFragment extends Fragment implements HorizontalScroll.ScrollViewListener, VerticalScroll.ScrollViewListener {
...
//        View view = layoutInflater.inflate(R.layout.stock_table_fragment,container,false);
        View view = layoutInflater.inflate(R.layout.stock_table_fragment, new TableMainLayout(getContext()), true);

//        RelativeLayout relativeLayout = view.findViewById(R.id.stock_table_view_layout);
//        relativeLayout.setLayoutParams(new TableLayout.LayoutParams());
//        RelativeLayout tempLayout = new TableMainLayout(getContext());
//        RelativeLayout relativeLayout = view.findViewById(R.id.stock_table_view_layout);


        //TODO: add typeface for fields
//        relativeLayoutMain= (RelativeLayout)view.findViewById(R.id.stock_table_view_layout);
//        getScreenDimension();
